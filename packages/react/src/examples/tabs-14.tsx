  ...
  return (
    <Tabs defaultValue="tab-1" className="items-center">
      <TabsList className="mx-auto flex w-full max-w-xs bg-transparent">
        <TabsTrigger value="tab-1" className="group flex-1 flex-col p-3 text-xs">
          <Badge className="mb-1.5 min-w-5 px-1 transition-opacity group-not-data-[selected]:opacity-50">
            3
          </Badge>
          Overview
        </TabsTrigger>
        <TabsTrigger value="tab-2" className="group flex-1 flex-col p-3 text-xs">
          <Badge className="mb-1.5 min-w-5 px-1 transition-opacity group-not-data-[selected]:opacity-50">
            0
          </Badge>
          Projects
        </TabsTrigger>
        <TabsTrigger value="tab-3" className="group flex-1 flex-col p-3 text-xs">
          <Badge className="mb-1.5 min-w-5 px-1 transition-opacity group-not-data-[selected]:opacity-50">
            7
          </Badge>
          Packages
