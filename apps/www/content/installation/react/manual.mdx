...
import CodeCollapsible from "@/components/content/code-collapsible"
...
<div>
  ```bash npm install class-variance-authority clsx tailwind-merge lucide-react tw-animate-css ```
</div>
